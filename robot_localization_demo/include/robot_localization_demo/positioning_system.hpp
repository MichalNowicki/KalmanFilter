...
namespace robot_localization_demo {
  ...
  class TurtlePositioningSystem {
    public:
      TurtlePositioningSystem(ros::NodeHandle node_handle, std::string topic_out, double frequency, double error_x_systematic,
          double error_x_random, double error_y_systematic, double error_y_random, double error_yaw_systematic,
          double error_yaw_random, int turtle_color_red, int turtle_color_green, int turtle_color_blue, bool visualize=false);
    ...
    private:
      ...
      int turtle_color_red_, turtle_color_green_, turtle_color_blue_;
      bool visualize_;
